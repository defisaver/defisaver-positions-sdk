...
describe('Morpho Aave v2', () => {
  ...
  const fetchMarketData = async (network, _web3) => {
    const marketData = await sdk.morphoAaveV2.getMorphoAaveV2MarketsData(_web3, network, '1650', web3);
  ...
  const fetchAccountBalances = async (network, web3, blockNumber) => {
    const balances = await sdk.morphoAaveV2.getMorphoAaveV2AccountBalances(web3, network, blockNumber, '0x9cCf93089cb14F94BAeB8822F8CeFfd91Bd71649');
