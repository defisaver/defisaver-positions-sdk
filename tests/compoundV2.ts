...
describe('Compound v2', () => {
  ...
  const fetchMarketData = async (network: NetworkNumber, _provider: EthereumProvider) => {
    const marketData = await sdk.compoundV2.getCompoundV2MarketsData(_provider, network);
  ...
  const fetchAccountData = async (network: NetworkNumber, _provider: EthereumProvider, marketData: sdk.CompoundV2MarketsData) => {
    const accountData = await sdk.compoundV2.getCompoundV2AccountData(_provider, network, '0x9cCf93089cb14F94BAeB8822F8CeFfd91Bd71649', marketData.assetsData);
  ...
  const fetchFullPositionData = async (network: NetworkNumber, _provider: EthereumProvider) => {
    const positionData = await sdk.compoundV2.getCompoundV2FullPositionData(_provider, network, '0x9cCf93089cb14F94BAeB8822F8CeFfd91Bd71649');
  ...
  const fetchAccountBalances = async (network: NetworkNumber, _provider: EthereumProvider, blockNumber: Blockish) => {
    const balances = await sdk.compoundV2.getCompoundV2AccountBalances(_provider, network, blockNumber, false, '0x9cCf93089cb14F94BAeB8822F8CeFfd91Bd71649');
