...
export const aaveV3AssetsDefaultMarketEth = [
  ...
  'eUSDe', 'PT USDe July', 'PT eUSDe Aug', 'EURC', 'FBTC', 'PT sUSDe Sep', 'PT USDe Sep', 'tETH', 'ezETH', 'XAUt', 'PT sUSDe Nov', 'PT USDe Nov', 'PT sUSDe Feb', 'PT USDe Feb', 'mUSD', 'syrupUSDT', 'USDG', 'PT sUSDe May', 'PT USDe May', 'PT srUSDe Apr', 'PT srUSDe Jun', 'PT srUSDe Oct', 'PT USDG May',
];
