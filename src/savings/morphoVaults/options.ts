...
export const MORPHO_VAULTS: Record<string, MorphoVault> = {
  [MORPHO_VAULT_FLAGSHIP_ETH.type]: MORPHO_VAULT_FLAGSHIP_ETH,
  [MORPHO_VAULT_GAUNTLET_USDC_CORE.type]: MORPHO_VAULT_GAUNTLET_USDC_CORE,
  [MORPHO_VAULT_GAUNTLET_USDC_PRIME.type]: MORPHO_VAULT_GAUNTLET_USDC_PRIME,
  [MORPHO_VAULT_RE7_WETH.type]: MORPHO_VAULT_RE7_WETH,
  [MORPHO_VAULT_GAUNTLET_WETH_CORE.type]: MORPHO_VAULT_GAUNTLET_WETH_CORE,
  [MORPHO_VAULT_GAUNTLET_WETH_PRIME.type]: MORPHO_VAULT_GAUNTLET_WETH_PRIME,
  [MORPHO_VAULT_BOOSTED_USDC.type]: MORPHO_VAULT_BOOSTED_USDC,
  [MORPHO_VAULT_STEAKHOUSE_PYUSD.type]: MORPHO_VAULT_STEAKHOUSE_PYUSD,
  [MORPHO_VAULT_FLAGSHIP_USDT.type]: MORPHO_VAULT_FLAGSHIP_USDT,
  [MORPHO_VAULT_STEAKHOUSE_USDT.type]: MORPHO_VAULT_STEAKHOUSE_USDT,
  [MORPHO_VAULT_GAUNTLET_USDA_CORE.type]: MORPHO_VAULT_GAUNTLET_USDA_CORE,
  [MORPHO_VAULT_GAUNTLET_USDT_PRIME.type]: MORPHO_VAULT_GAUNTLET_USDT_PRIME,
  [MORPHO_VAULT_GAUNTLET_RESOLV_USDC.type]: MORPHO_VAULT_GAUNTLET_RESOLV_USDC,
};
